...
<button class="button" onclick={handleOnClick} class:inactive={disable}>
    <div class="bg"></div>
    <svg
    ...
    <div class="wrap">
      ...
      <div class="content">
        <span class="char state-1">
          <span data-label="P" style="--i: 1">J</span>
          <span data-label="l" style="--i: 2; margin-left: 0.25rem;">o</span>
          <span data-label="a" style="--i: 3; margin-left: -0.375rem;">i</span>
          <span data-label="y" style="--i: 4; margin-left: 0.5rem">n</span>
          <span data-label="N" style="--i: 5">T</span>
          <span data-label="o" style="--i: 6; margin-left: 0.35rem">o</span>
          <span data-label="w" style="--i: 7; margin-left: 0.05rem">d</span>
        </span>
        ...
        <span class="char state-2">
          <span data-label="R" style="--i: 1; margin-left: -0.9rem">J</span>
          <span data-label="e" style="--i: 2; margin-left: 0.25rem">o</span>
          <span data-label="a" style="--i: 3; margin-left: 0.0rem">i</span>
          <span data-label="d" style="--i: 4; margin-left: 0.5rem">n</span>
          <span data-label="y" style="--i: 5; margin-left: 0.1rem">N</span>
          <span data-label="?" style="--i: 6">o</span>
        </span>
      </div>
    </div>
  </button>
...
button.inactive {
    /* opacity: .75; */
    animation: jello cubic-bezier(0.455, 0.03, 0.515, 0.955) linear infinite !important;
}
...
@keyframes jello {
  ...
  11.1%,
  to {
    transform: rotate(353deg) skewX(4deg) translate3d(0, 0, 0);
  }

  22.2% {
    transform: rotate(353deg) skewX(-12.5deg) skewY(-12.5deg);
  }

  33.3% {
    transform: rotate(353deg) skewX(6.25deg) skewY(6.25deg);
  }

  44.4% {
    transform: rotate(353deg) skewX(-3.125deg) skewY(-3.125deg);
  }

  55.5% {
    transform: rotate(353deg) skewX(1.5625deg) skewY(1.5625deg);
  }

  66.6% {
    transform: rotate(353deg) skewX(-0.78125deg) skewY(-0.78125deg);
  }

  77.7% {
    transform: rotate(353deg) skewX(0.390625deg) skewY(0.390625deg);
  }

  88.8% {
    transform: rotate(353deg) skewX(-0.1953125deg) skewY(-0.1953125deg);
  }
}
</style>